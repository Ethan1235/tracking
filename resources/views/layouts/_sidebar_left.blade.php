        ...
        <aside class="sidebar sidebar-left">
            <div class="sidebar-profile">
                <div class="avatar">
                    <img class="img-circle profile-image" src="/picture/profile.jpg" alt="profile">
            ...
            <nav>
                ...
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <!--UI Elements 标签-->
                    <li class="nav-dropdown {{ route_class_l1('help') }} {{ route_class_l1('about') }}" >  
                        <a href="#" title="Pages">
                            <i class="fa  fa-fw fa-cogs"></i> Pages
                        </a>
                        <ul class="nav-sub">
                            <li class="  {{ route_class_l2('help') }} ">
                                <a href="{{ route('help') }}" title=" Help">
                                     Help
                                </a>
                            </li>
                            <li class="  {{ route_class_l2('about') }} ">
